...
def income_by_year():
    ...
    cur.execute(
        'SELECT year, base_salary, overtime_pay, allowances, transport, expense_reimburse, income_other , health_insurance, pension, employment_insuranceFROM salaries GROUP BY year'
    ).fetchall()
