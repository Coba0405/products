...
def test_income_by_year(monkeypatch, tmp_path):
    ...
    assert y2024["income"] == income_2024_manual

    deduction_2024_manual = (
        (10000+15000+1000+0+5000+10000+0-0) +
        (10000+15000+1000+0+5200+10000+0-0) +
        (15000+20000+1500+0+8000+15000+0-0)
    )
