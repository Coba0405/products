...
def income_by_year():
    ...
    # rows = cur.execute("""
    #         'SELECT year,base_salary, overtime_pay, allowances, transport, expense_reimburse, income_other,
    #                      health_insurance, pension, employment_insurance, nursing_insurance, income_tax, resident_tax, deduction_other, refund
    ...
    SELECT year, SUM(base_salary + overtime_pay + allowances + transport + expense_reimburse+  income_other) AS total_income,
                 SUM(health_insurance + pension + employment_insurance + nursing_insurance + income_tax + resident_tax + deduction_other + refund) AS total_
    """


    total_income = sum(base_salary, overtime_pay, allowances, transport, expense_reimburse, income_other)
    total_deduction = sum(health_insurance, pension, employment_insurance, nursing_insurance, income_tax, resident_tax, deduction_other, refund)
