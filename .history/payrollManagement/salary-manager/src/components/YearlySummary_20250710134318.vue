    ...
    <div class="max-w-2xl mx-auto p-4">
        ...
        <div class="max-w-md mx-auto">
            <div class="bg-blue-100 p-4 rounded mb-4 grid grid-cols-3 text-center">
                <div>
                    <p class="text-gray-auto">収入</p>
                    <p class="text-lg font-bold text-blue-auto">{{ totalIncome.toLocaleString() }}</p>
                </div>
                <div>
                    <p class="text-gray-auto">控除</p>
                    <p class="text-lg font-bold text-red-auto">{{ totalDeduction.toLocaleString() }}</p>
                </div>
                <div>
                    <p class="text-gray-auto">手取り</p>
        ...
        <table class="w-full table-auto border-collapse">
            ...
            <tbody>
                ...
                <!-- <tr v-for="row in monthlyData" :key="row.month">
                    ...
                    <td class="border p-2 text-blue-600">100000</td>
                    <td class="border p-2 text-red-600">30000</td>
                    <td class="border p-2">{{ (100000 - 30000) }}</td>
                </tr> -->
            </tbody>
        </table>
    </div>
