<template>
    <div v-if="detail" class="p-6">
        ...
        <p>雇用保険料: {{ detail.income_other.toLocaleString() }} 円</p>
        <p>介護保険料: {{ detail.income_other.toLocaleString() }} 円</p>
        <p>社会保険料: {{ detail.income_other.toLocaleString() }} 円</p>
        <p>所得税: {{ detail.income_other.toLocaleString() }} 円</p>
        <p>住民税: {{ detail.income_other.toLocaleString() }} 円</p>
        <p>その他控除: {{ detail.income_other.toLocaleString() }} 円</p>
        <p>還付金: {{ detail.income_other.toLocaleString() }} 円</p>
    </div>
