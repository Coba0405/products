  ...
  <div class="border p-6 rounded shadow-md bg-white max-w-2xl mx-auto">
    ...
    <form @submit.prevent="submitForm" class="text-flex">
      ...
      <div class="flex items-center gap-4 mr-10">
        ...
        <input v-model="form.company" type="text" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" required />
      </div>
      ...
      <div class="flex items-center gap-4 mt-5 mr-10">
        ...
        <input v-model.number="form.base_salary" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>

      <div class="flex items-center gap-4 mt-5 mr-10">
        <label class="block text-sm mb-1">時間外勤務</label>
        <input v-model.number="form.overtime_pay" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>

      <div class="flex items-center gap-4 mt-5 mr-10">
        <label class="block text-sm mb-1">各種手当</label>
        <input v-model.number="form.allowances" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>

      <div class="flex items-center gap-4 mt-5 mr-10">
        <label class="block text-sm mb-1">交通費</label>
        <input v-model.number="form.transport" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>

      <div class="flex items-center gap-4 mt-5 mr-10">
        <label class="block text-sm mb-1">立替経費</label>
        <input v-model.number="form.expense_reimburse" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>

      <div class="flex items-center gap-4 mt-5 mr-10">
        <label class="block text-sm mb-1">その他収入</label>
        <input v-model.number="form.income_other" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>

      <h2 class=" text-red-600 mt-5">控除</h2>
      <div class="flex items-center gap-4 mt-5 mr-10">
        <label class="block text-sm mb-1">健康保険料</label>
        <input v-model.number="form.health_insurance" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>

      <div class="flex items-center gap-4 mt-5 mr-10">
        <label class="block text-sm mb-1">厚生年金保険料</label>
        <input v-model.number="form.pension" type="number" class="input flex-1 rounded px-2 py-1 ml-[60px] bg-gray-300" />
      </div>
