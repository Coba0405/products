...
import YearLineChart from './YearLineChart.vue'
    ...
    function changeYear(delta){ currentYear.value += delta router.replace({ path:'/', query:{ year: currentYear.value } })}
    function changeYear(delta){
  currentYear.value += delta, router.replace({ path:'/', query:{ year: currentYear.value } })}
