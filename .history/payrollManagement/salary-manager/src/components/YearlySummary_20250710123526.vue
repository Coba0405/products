    ...
    <div class="max-w-2xl mx-auto p-4">
        ...
        <div class="bg-blue-100 p-4 rounded mb-4 grid grid-cols-3 text-center">
            <div>
                ...
                <p class="text-lg font-bold text-blue-600">{{ totalIncome.toLcaleString() }}</p>
            </div>
            <div>
                <p class="text-gray-600">控除</p>
                <p class="text-lg font-bold text-red-600">{{ totalDeduction.toLcaleString() }}</p>
            </div>
            <div>
                <p class="text-gray-600">手取り</p>
                <p class="text-lg font-bold"> {{ netIncome.toLcaleString() }}</p>
            </div>
        </div>
    </div>
</template>
