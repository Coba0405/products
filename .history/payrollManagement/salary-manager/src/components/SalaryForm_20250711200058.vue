  ...
  <div class="border p-6 rounded shadow-md bg-white max-w-lg mx-auto">
    ...
    <form @submit.prevent="submitForm" class="space-y-3">
      <div>
        ...
        <input v-model.number="form.company" type="text" class="input bg-gray-300" required />
      </div>
      ...
      <div>
        ...
        <input v-model.number="form.holiday_work" type="number" class="input bg-gray-300" />
      </div>
