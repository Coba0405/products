<template>
    <div v-if="detail" class="p-6">
        ...
        <h3>勤怠</h3>
        <p>勤務日数: {{ detail.refund.toLocaleString() }}</p>
        <p>有給休暇: {{ detail.refund.toLocaleString() }}</p>
        <p>就労時間: {{ detail.refund.toLocaleString() }}</p>
        <p>法定内残業: {{ detail.refund.toLocaleString() }}</p>
        <p>法定外残業: {{ detail.refund.toLocaleString() }}</p>
        <p>休日出勤数: {{ detail.refund.toLocaleString() }}</p>
    </div>
