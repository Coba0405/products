<template>
    <div v-if="detail" class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Section title="差引合計" :rows="netRows" outerClass="col-span-3" />
...
const incomeTotal = computed(() =>
    incomeDetailRows.value.reduce((s, [,v]) => s + v, 0))

const deductDetailRows = computed(() =>
    deductDetailRows.value.reduce((s, [,v]) => s + v, 0))
...
const deductlRows = computed(() =>
    deductDetailRows.value.map(([l,v]) => [l, fmt]) )
