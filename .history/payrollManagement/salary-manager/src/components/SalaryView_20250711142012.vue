...
const deductRows = computed(() => detail.value ? [
  ...
  ['合計', fmt(detail.value.health_insurance +
            detail.value.pension + detail.value.employment_insurance + detail.value.nursing_insurance + detail.value.social_insurance + detail.value.income_tax + detail.value.resident_tax +detail.value.deduction_other + -detail.value.refund)]
] : [])
