...
def income_by_year():
    ...
    rows = cur.execute("""
            'SELECT year,
                       base_salary, overtime_pay, allowances, transport, expense_reimburse, income_other , health_insurance, pension, employment_insurance, nursing_insurance, income_tax, resident_tax, deduction_other, refund FROM salaries GROUP BY year'
          """).fetchall()
